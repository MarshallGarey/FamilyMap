...
import com.example.mgarey2.familymap.client.AuthorizationData;
...
public class MainActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mServerHostView = (EditText) findViewById(R.id.server_host);
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            if (!success) {
                // login failed
                Log.w("Main Activity", "Login failed");
                return false;
            }
            else {
                // login succeeded.
                // TODO: Create map fragment.
                Log.w("Main Activity", "Login successful");
                return false;
            }
